...
#%w( visitors map hasuk_houses ).each do |controller|
#  Rails.application.config.assets.precompile += ["#{controller}.coffee","#{controller}.js.coffee", "#{controller}.css"]
#end
...
Rails.application.config.assets.precompile += %w( framework_and_overrides.css.scss )
Rails.application.config.assets.precompile += %w( framework_and_overrides.css )
